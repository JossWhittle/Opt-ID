...
# Test imports
import optid
from optid.utils import Range, validate_range
...
class ValidateRangeTest(unittest.TestCase):
    ...
    def test_type(self):
        ...
        validate_range(axis_range=Range(-1, 1, 10))
    ...
    def test_element_type(self):
        ...
        self.assertRaisesRegex(optid.errors.ValidateRangeElementTypeError, '.*', validate_range,
                               axis_range=Range(None, 1, 10))

        self.assertRaisesRegex(optid.errors.ValidateRangeElementTypeError, '.*', validate_range,
                               axis_range=Range(-1, None, 10))

        self.assertRaisesRegex(optid.errors.ValidateRangeElementTypeError, '.*', validate_range,
                               axis_range=Range(-1, 1, None))
    ...
    def test_steps(self):
        ...
        validate_range(axis_range=Range(-1, 1, 1))

        self.assertRaisesRegex(optid.errors.ValidateRangeStepsError, '.*', validate_range,
                               axis_range=Range(-1, 1, 0))

        self.assertRaisesRegex(optid.errors.ValidateRangeStepsError, '.*', validate_range,
                               axis_range=Range(-1, 1, -1))
